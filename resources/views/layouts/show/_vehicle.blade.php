<div class="panel panel-primary">
	<div class="panel-heading">
		...
		<a href="/vehicles/{{ $vehicle->plate_num }}/edit" class="btn btn-success btn-xs pull-right">
			<i class="fa fa-pencil-square-o fa-lg"></i>
		</a>
		<span class="pull-right">&nbsp;</span><span class="pull-right">&nbsp;</span>
		<a href="/vehicles/{{ $vehicle->id }}/print" class="btn btn-info btn-xs pull-right">
			<i class="fa fa-print fa-lg"></i>
		</a>
		<span class="pull-right">&nbsp;</span><span class="pull-right">&nbsp;</span>
		<a href="/vehicles/{{ $vehicle->id }}/export" class="btn btn-warning btn-xs pull-right">
