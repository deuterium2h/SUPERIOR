<div id="accordion">
	<div id="applicant-info">
		<b><legend>Driver's Information</legend></b>
	...
	<div id="driver-ids">
		<b><legend>Driver's Vehicle Registration Information</legend></b>
		<div class="form-group">
			<div class="col-md-4">
				{!! Form::label('license', 'Driver\'s License Number:') !!}
				{!! Form::text('license', old('license'), ['class' => 'form-control', 'required']) !!}
			</div>
			<div class="col-md-2">
				{!! Form::label('license_exp', 'Expiry Date:') !!}
				{!! Form::date('license_exp', old('license_exp'), ['class' => 'form-control', 'required']) !!}
			</div>
			<div class="col-md-4">
				{!! Form::label('nbi_num', 'NBI Number:') !!}
				{!! Form::text('nbi_num', old('nbi_num'), ['class' => 'form-control', 'required']) !!}
			</div>
			<div class="col-md-2">
				{!! Form::label('nbi_exp', 'Expiry Date:') !!}
				{!! Form::date('nbi_exp', old('nbi_exp'), ['class' => 'form-control']) !!}
			</div>
		</div>&nbsp;
		<div class="form-group">
			<div class="col-md-4">
				{!! Form::label('sbma_num', 'SBMA ID Number:') !!}
				{!! Form::text('sbma_num', old('sbma_num'), ['class' => 'form-control']) !!}
			</div>
			<div class="col-md-2">
				{!! Form::label('sbma_exp', 'Expiry Date:') !!}
				{!! Form::date('sbma_exp', old('sbma_exp'), ['class' => 'form-control']) !!}
			</div>
			<div class="col-md-4">
				{!! Form::label('sbma_led_cert_num', 'SBMA Led Certificate Number:') !!}
				{!! Form::text('sbma_led_cert_num', old('sbma_led_cert_num'), ['class' => 'form-control']) !!}
			</div>
			<div class="col-md-2">
				{!! Form::label('sbma_led_cert_exp', 'Expiry Date:') !!}
				{!! Form::date('sbma_led_cert_exp', old('sbma_led_cert_exp'), ['class' => 'form-control']) !!}
			</div>
		</div>&nbsp;
		<div class="form-group">
			<div class="col-md-4">
				{!! Form::label('pwg_num', 'PWG ID Number:') !!}
				{!! Form::text('pwg_num', old('pwg_num'), ['class' => 'form-control']) !!}
			</div>
			<div class="col-md-2">
				{!! Form::label('pwg_exp', 'Expiry Date:') !!}
				{!! Form::date('pwg_exp', old('pwg_exp'), ['class' => 'form-control']) !!}
			</div>
			<div class="col-md-4">
				{!! Form::label('med_cert_num', 'Medical Certificate Number:') !!}
				{!! Form::text('med_cert_num', old('med_cert_num'), ['class' => 'form-control']) !!}
			</div>
			<div class="col-md-2">
				{!! Form::label('med_cert_exp', 'Expiry Date:') !!}
				{!! Form::date('med_cert_exp', old('med_cert_exp'), ['class' => 'form-control']) !!}
			</div>
		</div>&nbsp;
	</div>
	<div id="family-info">
	...
	<div id="guardian-info">
		...
		<div class="form-group">
			<div class="col-md-6">
				...
				{!! Form::text('reg_date', $submitButton=='Add New Driver' ? date('Y-m-d') : old('reg_date'), ['class' => 'form-control', 'readonly']) !!}
			</div>
			<div class="col-md-6">
