...
class CreateDriversTable extends Migration
{
	...
	public function up()
	{
		Schema::create('drivers', function (Blueprint $table) {
			...
			$table->string('license_exp')->nullable();
			$table->string('sbma_num');
			$table->string('sbma_exp')->nullable();
			$table->string('pwg_num');
			$table->string('pwg_exp')->nullable();
			$table->string('nbi_num');
			$table->string('nbi_exp')->nullable();
			$table->string('med_cert_num');
			$table->string('med_cert_exp')->nullable();
			$table->string('sbma_led_cert_num');
			$table->string('sbma_led_cert_exp')->nullable();
